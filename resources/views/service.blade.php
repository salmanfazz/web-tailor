...
@section('content')
    ...
    <form action="{{ url('/konsumen/serviceAdd') }}" method="post" class="p-3 mt-3">
        ...
        <div class="input-group mb-3">
            ...
            <input type="text" name="lingkar_dada" id="lingkar_dada" class="form-control"
        ...
        <div class="input-group mb-3">
            ...
            <input type="text" name="lingkar_pinggul" id="lingkar_pinggul" class="form-control"
                aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
        </div>
        <div class="input-group mb-3">
            <div class="input-group-prepend">
            ...
            <input type="text" name="lingkar_pinggang" id="lingkar_pinggang" class="form-control"
                aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
        </div>
        <div class="input-group mb-3">
            <div class="input-group-prepend">
            ...
            <input type="text" name="panjang_baju" id="panjang_baju" class="form-control"
                aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
        </div>
        <div class="input-group mb-3">
            <div class="input-group-prepend">
            ...
            <input type="text" name="panjang_lengan" id="panjang_lengan" class="form-control"
                aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
        </div>
        <div class="input-group mb-3">
            <div class="input-group-prepend">
            ...
            <input type="text" name="panjang_celana" id="panjang_celana" class="form-control"
                aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
        </div>
        <div class="input-group mb-3">
            <div class="input-group-prepend">
            ...
            <input type="text" name="keterangan" id="keterangan" class="form-control" aria-label="Sizing example input"
